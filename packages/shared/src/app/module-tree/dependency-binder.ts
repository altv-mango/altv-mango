    ...
    public async bind(resolvedTree: Tree<Module>) {
        await resolvedTree.asyncTraverse(async (node) => {
            ...
            this.loggerService.log(
                [chalk.magentaBright('Bind'), chalk.blueBright(module.metadata.classRef.name)],
                `→ [ internal: ${module.metadata.internalProviders.size} | external: ${module.metadata.externalProviders.size} ]` +
