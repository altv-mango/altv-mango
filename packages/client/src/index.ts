...
import {
    ...
    WebSocketClient,
    WebView,
    type _WebViewCreateOptionsDrawable,
    type _WebViewCreateOptionsOverlay,
} from '@altv/client';
...
class ClientAppBuilder extends AppBuilder<Guard, Interceptor, ErrorFilter> {
    public addWebView(id: string | number, options: _WebViewCreateOptionsDrawable): ClientAppBuilder;
    public addWebView(id: string | number, options: _WebViewCreateOptionsOverlay): ClientAppBuilder;
    public addWebView(id: string | number, options: _WebViewCreateOptionsOverlay) {
