...
import type { ConfigFactoryKeyHost } from './utils';
...
export class ConfigModule {
    ...
    private static readonly _envVariablesLoaded = new Promise<void>((resolve) => (ConfigModule.environmentVariablesLoadedSignal = resolve));
    ...
    private static loadEnvFile(envFilePaths: string[], options: ConfigModuleOptions): Record<string, any> {
