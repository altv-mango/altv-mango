...
export interface EventService {
    ...
    onceConnectionQueueAdd(
        callback: ServerEventsV2.GenericEventCallback<ServerEventsV2.ConnectionQueueEventParameters>,
    ): ScriptEventHandler;
    ...
    onPlayerConnect<T extends Player>(
        callback: ServerEventsV2.GenericPlayerEventCallback<ServerEventsV2.PlayerConnectEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onPlayerConnectDenied(
        callback: ServerEventsV2.GenericEventCallback<ServerEventsV2.PlayerConnectDeniedEventParameters>,
    ): ScriptEventHandler;
    ...
    onPlayerDisconnect<T extends Player>(
        callback: ServerEventsV2.GenericPlayerEventCallback<ServerEventsV2.PlayerDisconnectEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onPlayerDamage<T extends Player>(
        callback: ServerEventsV2.GenericPlayerEventCallback<ServerEventsV2.PlayerDamageEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onPlayerDeath<T extends Player>(
        callback: ServerEventsV2.GenericPlayerEventCallback<ServerEventsV2.PlayerDeathEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onPlayerHeal<T extends Player>(
        callback: ServerEventsV2.GenericPlayerEventCallback<ServerEventsV2.PlayerHealEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onPlayerControlRequest<T extends Player>(
        callback: ServerEventsV2.GenericCancellablePlayerEventCallback<ServerEventsV2.PlayerControlRequestEventParameters, T>,
    ): ScriptEventHandler;
    oncePlayerControlRequest<T extends Player>(
        callback: ServerEventsV2.GenericCancellablePlayerEventCallback<ServerEventsV2.PlayerControlRequestEventParameters, T>,
    ): ScriptEventHandler;
    onPlayerInteriorChange<T extends Player>(
        callback: ServerEventsV2.GenericPlayerEventCallback<ServerEventsV2.PlayerInteriorChangeEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onPlayerDimensionChange<T extends Player>(
        callback: ServerEventsV2.GenericPlayerEventCallback<ServerEventsV2.PlayerDimensionChangeEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onPlayerWeaponChange<T extends Player>(
        callback: ServerEventsV2.GenericPlayerEventCallback<ServerEventsV2.PlayerWeaponChangeEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onPlayerSyncedSceneRequest(
        callback: ServerEventsV2.GenericCancellableEventCallback<ServerEventsV2.PlayerSyncedSceneRequestEventParameters>,
    ): ScriptEventHandler;
    ...
    onPlayerSyncedSceneStart<T extends Player>(
        callback: ServerEventsV2.GenericCancellablePlayerEventCallback<ServerEventsV2.PlayerSyncedSceneStartEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onPlayerSyncedSceneStop<T extends Player>(
        callback: ServerEventsV2.GenericCancellablePlayerEventCallback<ServerEventsV2.PlayerSyncedSceneStopEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onPlayerSyncedSceneUpdate<T extends Player>(
        callback: ServerEventsV2.GenericCancellablePlayerEventCallback<ServerEventsV2.PlayerSyncedSceneUpdateEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onPlayerAnimationChange<T extends Player>(
        callback: ServerEventsV2.GenericPlayerEventCallback<ServerEventsV2.PlayerAnimationChangeEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onPlayerVehicleEntered<T extends Player>(
        callback: ServerEventsV2.GenericPlayerEventCallback<ServerEventsV2.PlayerVehicleEnteredEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onPlayerStartVehicleEnter<T extends Player>(
        callback: ServerEventsV2.GenericPlayerEventCallback<ServerEventsV2.PlayerStartVehicleEnterEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onPlayerVehicleLeft<T extends Player>(
        callback: ServerEventsV2.GenericPlayerEventCallback<ServerEventsV2.PlayerVehicleLeftEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onPlayerVehicleSeatChange<T extends Player>(
        callback: ServerEventsV2.GenericPlayerEventCallback<ServerEventsV2.PlayerVehicleSeatChangeEventParameters, T>,
    ): ScriptEventHandler;
    onPlayerVehicleSeatChange(
        callback: ServerEventsV2.GenericEventCallback<ServerEventsV1['playerChangedVehicleSeat']>,
    ): ScriptEventHandler;
    oncePlayerVehicleSeatChange<T extends Player>(
        callback: ServerEventsV2.GenericPlayerEventCallback<ServerEventsV2.PlayerVehicleSeatChangeEventParameters, T>,
    ): ScriptEventHandler;
    oncePlayerVehicleSeatChange(
        callback: ServerEventsV2.GenericEventCallback<ServerEventsV1['playerChangedVehicleSeat']>,
    ): ScriptEventHandler;
    ...
    onVehicleSirenStateChange(
        callback: ServerEventsV2.GenericEventCallback<ServerEventsV2.VehicleSirenStateChangeEventParameters>,
    ): ScriptEventHandler;
    ...
    onVehicleHornStateChange<T extends Player>(
        callback: ServerEventsV2.GenericCancellablePlayerEventCallback<ServerEventsV2.VehicleHornStateChangeEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onVoiceConnectionCreate(
        callback: ServerEventsV2.GenericEventCallback<ServerEventsV2.VoiceConnectionEventParameters>,
    ): ScriptEventHandler;
    ...
    onClientObjectRequest<T extends Player>(
        callback: ServerEventsV2.GenericCancellablePlayerEventCallback<ServerEventsV2.ClientObjectEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onWeaponDamage(
        callback: ServerEventsV2.GenericCancellableEventCallback<ServerEventsV2.WeaponDamageEventParameters>,
    ): ScriptEventHandler;
    ...
    onLocalMetaChange<T extends Player>(
        callback: ServerEventsV2.GenericPlayerEventCallback<ServerEventsV2.LocalMetaChangeEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onStreamSyncedMetaChange(
        callback: ServerEventsV2.GenericEventCallback<ServerEventsV2.StreamSyncedMetaChangeEventParameters>,
    ): ScriptEventHandler;
    ...
    onGlobalSyncedMetaChange(
        callback: ServerEventsV2.GenericEventCallback<ServerEventsV2.GlobalSyncedMetaChangeEventParameters>,
    ): ScriptEventHandler;
    ...
    onFireStart<T extends Player>(
        callback: ServerEventsV2.GenericCancellablePlayerEventCallback<ServerEventsV2.FireStartEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onProjectileStart<T extends Player>(
        callback: ServerEventsV2.GenericCancellablePlayerEventCallback<ServerEventsV2.ProjectileStartEventParameters, T>,
    ): ScriptEventHandler;
    ...
    onEntityColShapeEnter(
        callback: ServerEventsV2.GenericEventCallback<ServerEventsV2.EntityColShapeEnterEventParameters>,
    ): ScriptEventHandler;
    ...
    onEntityColShapeLeave(
        callback: ServerEventsV2.GenericEventCallback<ServerEventsV2.EntityColShapeLeaveEventParameters>,
    ): ScriptEventHandler;
    ...
    onEntityCheckpointEnter(
        callback: ServerEventsV2.GenericEventCallback<ServerEventsV2.EntityCheckpointEnterEventParameters>,
    ): ScriptEventHandler;
    onceEntityCheckpointEnter(
        callback: ServerEventsV2.GenericEventCallback<ServerEventsV2.EntityCheckpointEnterEventParameters>,
    ): ScriptEventHandler;
    onEntityCheckpointLeave(
        callback: ServerEventsV2.GenericEventCallback<ServerEventsV2.EntityCheckpointLeaveEventParameters>,
    ): ScriptEventHandler;
    onceEntityCheckpointLeave(
        callback: ServerEventsV2.GenericEventCallback<ServerEventsV2.EntityCheckpointLeaveEventParameters>,
    ): ScriptEventHandler;
    onGivePedScriptedTask(
        callback: ServerEventsV2.GenericEventCallback<ServerEventsV2.GivePedScriptedTaskEventParameters>,
    ): ScriptEventHandler;
